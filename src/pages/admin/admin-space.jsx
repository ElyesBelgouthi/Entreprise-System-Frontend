          ...
          <div className="flex-1 overflow-auto py-2">
            <nav className="grid items-start px-4 pt-8 space-y-4 text-sm font-medium">
              <NavLink
                ...
                to="/admin/"
                className={({ isActive }) =>
                  `flex items-center gap-3 rounded-lg px-3 py-2 text-xl transition-all hover:text-gray-900 dark:bg-gray-800 dark:text-gray-50 dark:hover:text-gray-50 ${
              ...
              <NavLink
                ...
                to="employees"
                className={({ isActive }) =>
                  `flex items-center gap-3 rounded-lg px-3 py-2  transition-all text-xl hover:text-gray-900 dark:bg-gray-800 dark:text-gray-50 dark:hover:text-gray-50 ${
                    isActive ? "text-gray-900" : "text-gray-500"
                  }`
                }
              >
